...
let expName = 'vSearchAlpha4';  // from the Builder filename that created this script
...
function trial1RoutineEachFrame(trials) {
  return function () {
    ...
    if (trial1Resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = trial1Resp.getKeys({keyList: ['b', 'm'], waitRelease: false});
...
function trial2RoutineEachFrame(trials) {
  return function () {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2L13.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2L14.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2L23.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2L24.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2T13.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial2T14.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    if (trial2Resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = trial2Resp.getKeys({keyList: ['b', 'm'], waitRelease: false});
...
function trial3RoutineEachFrame(trials) {
  return function () {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L13.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L14.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L23.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L24.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3T13.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3T14.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L15.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L16.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L25.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3L26.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3T15.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    frameRemains = 1.0 + 3.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
    if (trial3T16.status === PsychoJS.Status.STARTED && t >= frameRemains) {
    ...
    if (trial3Resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = trial3Resp.getKeys({keyList: ['b', 'm'], waitRelease: false});
